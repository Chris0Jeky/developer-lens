...
const config = {"id":"developer-lens","project":{"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms","story.opened","share.requested"],"routes":["home","story","share"],"releases":["unattributed"],"measurements":["duration.ms"]},"origin":"https://chris0jeky.github.io","endpoint":"","scopePath":"/developer-lens/","release":"unattributed","route":"home","clicks":[]};
