...
function card(overrides: { maximumRequests?: number } = {}): GithubCoreActivationTaskCard {
  return parseGithubCoreActivationTaskCard({
    ...
    localBoundary: { root: '.developer-lens/activation/transport-fixture/', taskCard: 'task-card.json', database: 'github-core.sqlite', installationKey: 'installation-key.bin', backupDirectory: 'backup/', report: 'last-run-report.json', continuityReviewAnchor: 'continuity-review-anchor.json', trackedOrPublished: false },
