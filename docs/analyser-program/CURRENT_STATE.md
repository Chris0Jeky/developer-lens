...
current_slice_override: 'Activation enforcement, the single-writer lease, the LIFE-03 selected-store
  ...
  complete and in its publication gate.'
...
merged: ['R1-R3 cards DL-OPS-CI-01 #70, DL-SPINE-04 #73, DL-SPINE-01 #74, DL-BRIDGE-01 #72,
  ...
  'state syncs #126']
active_slice: 'DL-LIFE-03 selection/grace (#162): schema 3.2.4/user_version 311 adds one immutable global migration_selection_state receipt with no artifact FK, exact replay, and an injected-UTC seven-day boundary. A v3-only selector holds the writer lease, proves the published selected store and finalized task-key-bound backup, commits the receipt under BEGIN IMMEDIATE, closes the writable provisional handle, reopens/revalidates read-only, and otherwise returns only a content-free legacy fallback without accepting a legacy path. The exact local full gate is green; hosted proof, final review, PR publication, and merge remain pending. Restore remains #163; cleanup and tombstone replay remain later LIFE-03 slices. The whyResolver lineage joins stay with Phase E, never the v2 resolver.'
