...
The 126-card programme is the long-term universe, **not** the standing execution queue. The active
...
126 cards. Generated by `taskdeck/tools/generate.mjs` from `taskdeck/tools/cards.mjs` — edit the
...
| DL-VALUE-01 | First deterministic comparative finding (integration shape, matched windows) | analytics-core | implementation | BLOCKED_BY_DEPENDENCY | A | DL-BRIDGE-01, DL-METRIC-01, DL-FINDING-01, DL-COMPARE-01, DL-SPINE-02, DL-SPINE-03, DL-UX-ED | M2 | medium/L |
